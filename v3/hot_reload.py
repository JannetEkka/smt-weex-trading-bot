...
def get_settings():
    ...
    defaults = {"confidence_threshold": 0.70, "pause_trading": False, "emergency_exit_all": False, "enable_longs": True, "enable_shorts": True, "tp_multiplier": 1.0, "sl_multiplier": 1.0}
    try:
