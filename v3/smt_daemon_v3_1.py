...
def run_daemon():
    ...
    logger.info("  - V3.2.18: Chop was blocking correct signals (ADA 88%% SHORT) and passing wrong ones via overrides")
    logger.info("  - V3.2.18: Shorts allowed for ALL 7 pairs (was LTC only). Ensemble decides direction.")
    logger.info("  - V3.2.18: In F&G<20, restricting to LONG only = fighting the trend. Trust the signals.")
    ...
    logger.info("  - V3.2.3: CHOP filter — FLOW EXTREME override [REMOVED V3.2.18: all chop penalties removed]")
