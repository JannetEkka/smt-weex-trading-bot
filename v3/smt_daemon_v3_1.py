...
def run_daemon():
    ...
    logger.info("  - V3.2.18: HIGH CHOP + FLOW EXTREME: -8%% penalty (was -15%%). ADA 88%% SHORT now passes (80%%)")
    logger.info("  - V3.2.18: MEDIUM CHOP + FLOW EXTREME: KEPT as skip (ETH 80%% LONG on ascending trend was correct)")
