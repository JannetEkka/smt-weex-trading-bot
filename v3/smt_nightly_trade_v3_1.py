...
TIER_CONFIG = {
    1: {  # BTC, ETH, BNB, LTC - Stable, slow movers
        ...
        "max_hold_hours": 12,    # V3.1.34: SURVIVAL - BTC reverses every 4-8h in this market
    ...
    2: {  # SOL - Mid volatility
        ...
        "max_hold_hours": 8,     # V3.1.34: SURVIVAL - quick in/out
        "early_exit_hours": 2,    # V3.1.34: Check earlier
    ...
    3: {  # DOGE, XRP, ADA - Fast movers
        ...
        "max_hold_hours": 4,     # V3.1.34: SURVIVAL - scalp mode
        "early_exit_hours": 2,    # V3.1.34: Check earlier
        "early_exit_loss_pct": -1.8,  # V3.1.32: Raised
        "force_exit_loss_pct": -3.0,  # V3.1.32: Raised
    },
...
{{"decision": "LONG" or "SHORT" or "WAIT", "confidence": 0.0-0.95, "tp_pct": number, "sl_pct": number, "reasoning": "2-3 sentences explaining your decision"}}"""
        ...
        try:
            ...
            if balance < 1000:
                position_usdt *= 0.5
                print(f"  [JUDGE] CRITICAL BALANCE: size halved")
            elif balance < 2000:
                position_usdt *= 0.7
            ...
            return {
                ...
                "tier": tier,
                "tier_name": tier_config["name"],
                "reasoning": f"Gemini Judge V3.1.39: {reasoning}. Votes: {', '.join(vote_summary)}",
...
def execute_trade(pair_info: Dict, decision: Dict, balance: float) -> Dict:
    ...
    # V3.1.32: ATR-based dynamic SL - stops outside normal volatility noise
    try:
        atr_data = get_btc_atr()
