...
class JudgePersona:
    ...
    def decide(self, persona_votes: List[Dict], pair: str, balance: float, 
        ...
        # V3.1.27: REGIME BLOCKING - Don't fight the trend
        ...
        # V3.1.21: RSI OVERBOUGHT FILTER (symmetric with oversold SHORT filter)
        rsi_value = 50
        for vote in persona_votes:
        ...
        # V3.1.21: Support proximity boost for LONGs (symmetric with resistance for SHORTs)
